...
<div class="container-my">
    <div class="form-container-my">
        ...
        <i class="bi bi-person-plus-fill me-2"></i>Thêm chuyên ngành mới
        </div>
        <form:form method="post" action="save" modelAttribute="major">
        
            <div class="mb-3">
                <label for="majorName" class="form-label">Tên chuyên ngành:</label>
                <form:input path="majorName" class="form-control" placeholder="Nhập tên chuyên ngành" />
            ...
            <div class="mb-3 form-check">
                ...
                <label for="status" class="form-check-label">Chuyên ngành đang hoạt động</label>
            </div>

            <div class="full-width">
                    <button type="submit" class="button button-submit mt-3 "> <i class="bi bi-save me-2"></i>Lưu</button>
                    <a href="${pageContext.request.contextPath}/major/major_view" class="button button-secondary mt-2">Hủy</a>
                </div>
        </form:form>
    </div>
</div>
