...
<jsp:include page="../header.jsp">
    ...
    <div class="form-container-my">
        ...
        <i class="bi bi-person-plus-fill me-2"></i>Thêm khoá sinh viên mới
        </div>
        <form:form method="post" action="save" modelAttribute="cohort">
        
            <div class="mb-3">
                <label for="cohortName" class="form-label">Tên Khoá:</label>
                <form:input path="cohortName" class="form-control" placeholder="Nhập tên khoá" />
            ...
            <div class="mb-3 form-check">
                ...
                <label for="status" class="form-check-label">Khoá đang hoạt động</label>
            </div>
